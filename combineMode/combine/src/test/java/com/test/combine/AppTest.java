...
import com.test.combine_mod.service.engine.IEngine;
import com.test.combine_mod.service.engine.impl.TreeEngineHandle;
...
public class AppTest 
{
  ...
  /* @Test
   public void test_EngineController() {
	   ...
	   String process = engineController.process("qijid", "man",29);
